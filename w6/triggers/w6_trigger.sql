...
CREATE DATABASE IF NOT EXISTS w6_triggers;
USE w6_triggers;
...
CREATE TRIGGER Tgr_Pedidos_Delete AFTER DELETE
ON Pedidos
FOR EACH ROW
BEGIN
...
DELETE FROM Pedidos WHERE Venda = 1 AND Produto = '001';
select * from produtos;
...
DROP TRIGGER Tgr_Pedidos_Insert;
...
#################################################################
################## BEFORE INSERT ################################
CREATE DATABASE IF NOT EXISTS w6_workcenters;
USE w6_workcenters;
